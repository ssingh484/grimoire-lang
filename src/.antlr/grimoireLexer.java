...
public class grimoireLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ARRAY", "BREAK", "DO", "IF", "ELSE", "FOR", "FUNC", "LET", "IN", "OF", 
			"THEN", "TO", "VAR", "WHILE", "ENDIF", "BEGIN", "END", "ENDDO", "RET", 
			"INT", "FLOAT", "ID", "INTLIT", "FLOATLIT", "COMMA", "COLON", "SEMICOLON", 
			"OPENBRACKET", "CLOSEBRACKET", "OPENSQBRACKET", "CLOSESQBRACKET", "ADD", 
			"SUB", "MULT", "DIV", "EQUAL", "NOTEQUAL", "LESS", "GREAT", "LESSEQUAL", 
			"GREATEQUAL", "AND", "OR", "ASSIGNMENT"
		};
	}
	...
	public grimoireLexer(CharStream input) {
		super(input);
